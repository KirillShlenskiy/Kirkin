...
namespace Kirkin.Linq
{
    ...
    public static class EnumerableExtensions
    {
        ...
        /// <summary>
        /// Optimised ToArray version which pre-allocates the destination
        /// array with the given number of elements to avoid copy.
        /// </summary>
        ...
        internal static bool TryGetCount<T>(this IEnumerable sequence, out int count)
        {
            ...
            ICollection<T> collectionOfT = sequence as ICollection<T>;
